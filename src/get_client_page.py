...
<body>
  <main>
    ...
    <pre>git clone https://gitlab.com/Pritz395/blt-netguardian.git
...
flutter run -d macos</pre>
    <p>
      ...
      <code style="display:inline;padding:2px 6px">https://blt-netguardian.preethampujari395.workers.dev</code>
    ...
    <p>
      Source:
      <a href="https://gitlab.com/Pritz395/blt-netguardian/-/tree/main/client">client/</a>
      ·
      <a href="https://gitlab.com/Pritz395/blt-netguardian/-/archive/main/blt-netguardian-main.zip">zip of repo</a>
    </p>
    <p>
      Headless alternative (not the GUI):
      <code style="display:inline;padding:2px 6px">curl -fsSL https://blt-netguardian.preethampujari395.workers.dev/install.sh | sh -s -- https://example.com</code>
    </p>
  </main>
</body>
</html>
